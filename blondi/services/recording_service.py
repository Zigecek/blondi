...
from blondi.services.map_storage import save_map_to_db
...
class RecordingService:
    ...
    def start(
        ...
        *,
        ...
        self._recorder.start_recording(
            ...
            session_name=f"blondi_{map_name_prefix}",
        )
    ...
    def capture_and_record_checkpoint(
        ...
        **Při totálním selhání capture** (žádná fotka) raise
        ...
        """
        from blondi.robot.dual_side_capture import capture_sources as cap_sources
    ...
    def stop_and_export(
        ...
        **Není idempotentní** — volat jen jednou po dokončení recordingu.
        ...
        try:
            ...
            try:
                from blondi.robot.graphnav_fiducial import (
                ...
                # (blondi v test módu může běžet bez full autonomy).
                _log.warning(
