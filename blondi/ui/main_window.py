...
from blondi import __app_name__, __version__
from blondi.config import AppConfig
from blondi.db import ping as db_ping
...
from blondi.ui.wizards.playback_wizard import PlaybackWizard
from blondi.ui.wizards.recording_wizard import RecordingWizard
from blondi.ui.wizards.walk_wizard import WalkWizard
...
class MainWindow(QMainWindow):
    ...
    def _connect_spot(self) -> bool:
        ...
        v test režimu.
        """
        from blondi.ui.common.connect_dialog import ConnectDialog
    ...
    def _register_crud_if_available(self) -> None:
        try:
            from blondi.ui.crud import crud_window  # noqa: F401
        except ImportError:
