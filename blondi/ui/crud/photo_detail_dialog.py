...
from blondi.constants import OCR_ENGINE_FAST_PLATE, OCR_ENGINE_NOMEROFF
from blondi.db.engine import Session
from blondi.db.enums import PlateStatus
from blondi.db.repositories import detections_repo, photos_repo, plates_repo
from blondi.db.repositories.photos_repo import PhotoMetadata
from blondi.logging_config import get_logger
from blondi.ocr.fallback import reprocess_bytes
...
from blondi.ui.common.workers import DbQueryWorker, FunctionWorker
...
class PhotoDetailDialog(QDialog):
    ...
    def _on_detection_clicked(self, href: str) -> None:
        ...
        from blondi.ui.crud.spz_tab import _SpzEditDialog
