...
from blondi.ui.wizards.pages.save_map_page import SaveMapPage
from blondi.ui.wizards.pages.teleop_record_page import TeleopRecordPage
from blondi.ui.wizards.state import RecordingWizardState
...
class RecordingWizard(SpotWizard):
    ...
    def _close_confirmation_message(self) -> str:
        from blondi.ui.wizards.messages import CLOSE_WARNING_RECORDING
