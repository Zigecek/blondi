...
from blondi.ui.wizards.pages.map_select_page import MapSelectPage
from blondi.ui.wizards.pages.playback_result_page import PlaybackResultPage
from blondi.ui.wizards.pages.playback_run_page import PlaybackRunPage
from blondi.ui.wizards.state import PlaybackWizardState
...
class PlaybackWizard(SpotWizard):
    ...
    def _close_confirmation_message(self) -> str:
        from blondi.ui.wizards.messages import CLOSE_WARNING_PLAYBACK
