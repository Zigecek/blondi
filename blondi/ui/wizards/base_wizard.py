...
from blondi.constants import UI_WIZARD_MIN_HEIGHT, UI_WIZARD_MIN_WIDTH
from blondi.logging_config import get_logger
from blondi.ui.common.dialogs import confirm_dialog
...
class SpotWizard(QWizard):
    ...
    def closeEvent(self, event: QCloseEvent) -> None:  # noqa: D401
        ...
        if not ok:
            ...
            from blondi.ui.wizards.messages import (
    ...
    def _should_confirm_close(self) -> bool:
        ...
        """
        from blondi.ui.wizards.state import (
