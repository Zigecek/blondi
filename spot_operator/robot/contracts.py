"""Protokolové kontrakty mezi ``spot_operator`` a ``autonomy``.
...
class NavigationResultProtocol(Protocol):
    """Co spot_operator očekává od ``autonomy.GraphNavNavigator.navigate_to``."""
...
class ImagePollerProtocol(Protocol):
    """Co spot_operator očekává od ``autonomy.ImagePoller``."""
...
class SessionProtocol(Protocol):
    """Co spot_operator očekává od ``autonomy.SpotSession``."""
...
class LeaseManagerProtocol(Protocol):
    """Co spot_operator očekává od ``autonomy.LeaseManager``."""
